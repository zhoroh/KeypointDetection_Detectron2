        ...
        def runOnVideo(video,maxFrames):# this is for debugging
            ...
            while True:
                ...
                if readFrames > maxFrames:
                    break
        num_frames = 20 # here  we reinitialize the number of frames because  of it'll take hours to write the detectedVideos to our video_file and since we don't have a gpu
